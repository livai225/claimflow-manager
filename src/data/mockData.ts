...
export const mockUsers: User[] = [
  ...
  {
    id: 'user-2',
    email: 'gestionnaire@assurance.fr',
    name: 'Pierre Martin',
    role: 'gestionnaire',
    avatar: 'PM',
  ...
  {
    id: 'user-4',
    email: 'superviseur@assurance.fr',
    name: 'Jean Leroy',
    role: 'superviseur',
    avatar: 'JL',
...
export const mockClaims: Claim[] = [
  {
    ...
    dateIncident: new Date('2024-12-01'),
    dateDeclaration: new Date('2024-12-02'),
    location: 'Paris 15e, Boulevard de Grenelle',
    description: 'Collision arrière à un feu rouge. Dégâts sur le pare-chocs et le coffre.',
    estimatedAmount: 3500,
    documents: [
      { id: 'doc-1', name: 'Constat amiable.pdf', type: 'constat', url: '#', uploadedAt: new Date('2024-12-02'), uploadedBy: mockUsers[5] },
      { id: 'doc-2', name: 'Photos dégâts.zip', type: 'photo', url: '#', uploadedAt: new Date('2024-12-02'), uploadedBy: mockUsers[5] },
    ],
    events: [
      { id: 'evt-1', type: 'creation', description: 'Déclaration de sinistre créée', date: new Date('2024-12-02'), user: mockUsers[5] },
      { id: 'evt-2', type: 'affectation', description: 'Dossier affecté à Pierre Martin', date: new Date('2024-12-02'), user: mockUsers[0] },
    ],
  ...
  },
  {
    ...
    declarant: mockUsers[5],
    assignedTo: mockUsers[1],
    dateIncident: new Date('2024-11-28'),
    dateDeclaration: new Date('2024-11-29'),
    location: 'Lyon 3e, Rue Garibaldi',
    description: 'Dégât des eaux suite à une fuite de la machine à laver du voisin du dessus.',
  ...
  },
  {
    ...
    location: 'Marseille, Avenue du Prado',
    description: 'Vol du véhicule sur le parking du centre commercial.',
  ...
  },
  {
    ...
    declarant: mockUsers[5],
    assignedTo: mockUsers[1],
    dateIncident: new Date('2024-11-10'),
    dateDeclaration: new Date('2024-11-12'),
    location: 'Bordeaux',
    description: 'Hospitalisation suite à une intervention chirurgicale programmée.',
  ...
  },
  {
    ...
    declarant: mockUsers[5],
    assignedTo: mockUsers[1],
    dateIncident: new Date('2024-09-15'),
    dateDeclaration: new Date('2024-09-16'),
    location: 'Nice, Promenade des Anglais',
    description: 'Accident de stationnement. Rétroviseur arraché.',
    estimatedAmount: 850,
    approvedAmount: 850,
    paidAmount: 850,
    documents: [
  ...
  },
  {
    ...
    declarant: mockUsers[5],
    assignedTo: mockUsers[1],
    dateIncident: new Date('2024-08-10'),
    dateDeclaration: new Date('2024-08-12'),
    location: 'Strasbourg',
    description: 'Dommage accidentel causé au bien d\'un tiers lors d\'un déménagement.',
